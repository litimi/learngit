...
export default {
  ...
  data () {
    return {
      ...
      value: '3333',
      selected: 1,
      name: this.$store.state.loginInfo.name ? this.$store.state.loginInfo.name : JSON.parse(localStorage.getItem('username')),
      total: '5',
      ...
      // xxdm: JSON.parse(localStorage.getItem('xxdm')),
      // usercode: JSON.parse(localStorage.getItem('susercode'))
    }
  },
  mounted () {
